...
Candidate: `candidate_000003`

P0-B semantic QA is intentionally shallow. It checks that the chain is complete, traceable, and usable for a human to continue. Passing P0-B QA does not mean the video is close to publishable or likely to become a hit.
